var Note = React.createClass({
    ...
    save: function () {
        this.props.onChange(this.refs.newText.getDOMNode().value, this.props.index); //save new entries
    ...
    propTypes: {
        count: function (props, propName) {
            ...
            if (props[propName] > 100) {
                return new Error("Are you kidding me? " + props[propName] + " notes are too much!");
            }
        }
    },
    getInitialState: function () {
